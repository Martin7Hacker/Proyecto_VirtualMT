...
Begin VB.Form frmentradasalida 
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdmas 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmentradasalida.frx":0CCA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image1 
         Height          =   1470
         Left            =   0
         Picture         =   "frmentradasalida.frx":0CE6
         Top             =   0
         Width           =   2175
      End
   End
   Begin VB.Frame frmframe 
      ...
      Begin VB.Image Image2 
         Height          =   2295
         Left            =   120
         Picture         =   "frmentradasalida.frx":B770
         Top             =   240
         Width           =   3525
      End
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdmod 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmentradasalida.frx":25ED6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdCrearEventos 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmentradasalida.frx":25EF2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdcancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmentradasalida.frx":25F0E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdfiltro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmentradasalida.frx":25F2A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Label labrutina 
      BackColor       =   &H00FFFFFF&
      BackStyle       =   0  'Transparent
      Caption         =   "Asistente  de Creacion de Timbres"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
'*
'*
'* Generador de Rutinas de Virtual Martin temporize v1.0
'*
'*
'***************************************************************************
...
Private Sub unoobarios()
 ...
 cmdCrearEventos.Caption = Lenguage.lenguage_opciones_generador(24)
 Else
 cmdCrearEventos.Caption = Lenguage.lenguage_opciones_generador(25)
 End If
End Sub
...
Private Sub cargar_controles()
 With cob1
 .AddItem Lenguage.lenguage_opciones_generador(27)
 .AddItem Lenguage.lenguage_opciones_generador(28)
 .AddItem Lenguage.lenguage_opciones_generador(29)
 .AddItem Lenguage.lenguage_opciones_generador(30)
 .AddItem Lenguage.lenguage_opciones_generador(31)
 .AddItem Lenguage.lenguage_opciones_generador(32)
 .AddItem Lenguage.lenguage_opciones_generador(33)
 .AddItem Lenguage.lenguage_opciones_generador(34)
 End With
End Sub
...
Private Sub Cantidad_elementos()
 ...
 Label1(8).Caption = Lenguage.lenguage_opciones_generador(17): cmdmod.Enabled = False
 ElseIf frmprograma.listado(0).ListCount = 1 Then
 Label1(8).Caption = Lenguage.lenguage_opciones_generador(18) _
 & " " & frmprograma.listado(0).ListCount & " " & _
 Lenguage.lenguage_opciones_generador(19): cmdmod.Enabled = True
 Else
 Label1(8).Caption = Lenguage.lenguage_opciones_generador(18) _
 & " " & frmprograma.listado(0).ListCount & " " & _
 Lenguage.lenguage_opciones_generador(19):: cmdmod.Enabled = True
...
Private Sub modificarDatos(ByVal control0 As Object, ByVal control1 As Object, _
 ...
 ByVal control14 As Object)
  Dim it As Integer
    ...
    .listado(1).List(it) = "Entrada"  ' entrada | salida
    End If
...
Case (True)
 ...
 End If
 If control1.Enabled = True Then
 .listado(1).List(it) = "Salida"  ' entrada | salida
 End If
 If control3.Enabled = True Then
...
Private Sub crearTimbre()
 ...
 Select Case (aleatorio)
  ...
  .listado(1).AddItem "Entrada" ' entrada | salida
...
Case (True)
.listado(0).AddItem DTPicker1.Value
.listado(1).AddItem "Salida" ' entrada | salida
...
Private Sub cargar_idioma()
 Me.Caption = Lenguage.lenguage_opciones_generador(0)
 If Check2.Value = 0 Then
 Me.Check2.Caption = Lenguage.lenguage_opciones_generador(2)
 ElseIf Check2.Value = 1 Then
 Me.Check2.Caption = Lenguage.lenguage_opciones_generador(1)
 End If
 cmdfiltro.Caption = Lenguage.lenguage_opciones_generador(3)
 Label1.Item(0).Caption = Lenguage.lenguage_opciones_generador(4)
 Label1.Item(1).Caption = Lenguage.lenguage_opciones_generador(5)
 Label1.Item(2).Caption = Lenguage.lenguage_opciones_generador(6)
 Label1.Item(3).Caption = Lenguage.lenguage_opciones_generador(7)
 Label1.Item(4).Caption = Lenguage.lenguage_opciones_generador(8)
 Label1.Item(5).Caption = Lenguage.lenguage_opciones_generador(9)
 Check1.Item(0).Caption = Lenguage.lenguage_opciones_generador(10)
 Check1.Item(1).Caption = Lenguage.lenguage_opciones_generador(11)
 Check1.Item(2).Caption = Lenguage.lenguage_opciones_generador(12)
 Check1.Item(3).Caption = Lenguage.lenguage_opciones_generador(13)
 Check1.Item(4).Caption = Lenguage.lenguage_opciones_generador(14)
 Check1.Item(5).Caption = Lenguage.lenguage_opciones_generador(15)
 Check1.Item(6).Caption = Lenguage.lenguage_opciones_generador(16)
 Label1.Item(6).Caption = Lenguage.lenguage_opciones_generador(21)
 Label1.Item(7).Caption = Lenguage.lenguage_opciones_generador(22)
 cmdCancelar.Caption = Lenguage.lenguage_opciones_generador(23)
 cmdmod.Caption = Lenguage.lenguage_opciones_generador(26)
 txtd.Text = Lenguage.lenguage_opciones_generador(35)
 labinfo.Caption = Lenguage.lenguage_opciones_generador(36)
 lbld.Caption = Lenguage.lenguage_opciones_generador(37)
 Label2.Caption = Lenguage.lenguage_opciones_generador(38)
End Sub
