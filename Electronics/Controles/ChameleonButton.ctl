VERSION 5.00
Begin VB.UserControl ChameleonBtn 
   AutoRedraw      =   -1  'True
   ClientHeight    =   510
   ClientLeft      =   0
   ClientTop       =   0
   ...
   End
End
Attribute VB_Name = "ChameleonBtn"
...
'***************************************************************************
'*
'* Chameleon Button funcionando en Virtual Martin temporize v1.0
'* Open Source
'* uso no Comercial
'*
'***************************************************************************
...
Private Sub UserControl_MouseUp(Button As Integer, Shift _
As Integer, x As Single, Y As Single)
...
Private Sub UserControl_Show()
 ...
 If pDC = 0 Then
 pDC = CreateCompatibleDC(UserControl.hdc): pBM _
 = CreateBitmap(Wi, He, 1, GetDeviceCaps(hdc, 12), ByVal 0&)
...
Private Sub DrawRectangle(ByVal x As Long, ByVal Y As Long, ByVal _
Width As Long, ByVal Height As Long, ByVal Color As Long, Optional _
OnlyBorder As Boolean = False)
...
Private Sub DrawEllipse(ByVal x As Long, ByVal Y As Long, ByVal Width _
 As Long, ByVal Height As Long, ByVal BorderColor As Long, ByVal FillColor _
 As Long)
...
Private Function ShiftColor(ByVal Color As Long, ByVal Value _
 As Long, Optional isXP As Boolean = False) As Long
...
Private Function ShiftColorOXP(ByVal theColor As Long, Optional ByVal Base _
 As Long = &HB0) As Long
 Dim Red As Long, Blue As Long, Green As Long
 Dim Delta As Long
...
Private Sub TransBlt(ByVal DstDC As Long, ByVal DstX As Long, _
 ByVal DstY As Long, ByVal DstW As Long, ByVal DstH As Long, _
 ByVal SrcPic As StdPicture, Optional ByVal TransColor As Long = -1, _
 Optional ByVal BrushColor As Long = -1, Optional ByVal MonoMask _
 As Boolean = False, Optional ByVal isGreyscale As Boolean _
 = False, Optional ByVal XPBlend As Boolean = False)
